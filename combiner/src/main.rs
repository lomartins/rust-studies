...
fn main() -> Result<(), ImageDataError> {
    ...
    let (image_1, image_2) = standardise_images(image_1, image_2);
...
fn standardise_images(image_1: DynamicImage, image_2: DynamicImage) -> (DynamicImage, DynamicImage) {
    ...
    if image_1.dimensions() == (width, height) {
        (image_1, image_2.resize_exact(width, height, FilterType::Triangle))
    } else {
